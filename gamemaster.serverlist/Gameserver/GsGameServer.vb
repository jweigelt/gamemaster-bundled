...
Namespace Gameserver
    Public Class GsGameServer
        Public Const BYTE_ZERO As Byte = 0
        Private ReadOnly doubleNull As String = ArrayFunctions.GetString({BYTE_ZERO, BYTE_ZERO})
        Private ReadOnly null As String = ArrayFunctions.GetString({BYTE_ZERO})
...
#End Region
        ...
        Public ReadOnly Property IsNatted As Boolean
            Get
                For i = 0 To GsConst.PARAM_MAX_LOCALIP_SEEK
...
#Region "Property storage"
        ...
        Private Function ManageTableData(ByRef arr() As Byte, ByRef tbl As ElementTable, ByVal offset As Int32) As Int32
            ...
            While index < (arr.Length - 1)
                ...
                header(header.Length - 1) = ArrayFunctions.ReadCString(arr, index)
            ...
            For i = 0 To rowCount - 1
                For j = 0 To header.Length - 1
                    data(i, j) = ArrayFunctions.ReadCString(arr, index)
                Next
            Next
            index += 1 'Add +1 to compensate the x0 x0 delimeter
        ...
        Private Sub ParseParameters(ByVal buf() As Byte)
            ...
            Dim part0Params() As String = str.Split(null)
        ...
        Public Function GetValue(ByVal varName As String) As String
            Dim propInfo As PropertyInfo = GetType(GsGameServer).GetProperty(varName, BindingFlags.Public Or BindingFlags.Instance Or BindingFlags.IgnoreCase)
            ...
            If propInfo Is Nothing Then
                ...
                If val = String.Empty Then
                    ...
                    val = GsConst.PARAM_UNKNOWN_REPLACEMENT 'Replace the property with at least "something"
                End If
            Else
                val = propInfo.GetValue(Me).ToString
